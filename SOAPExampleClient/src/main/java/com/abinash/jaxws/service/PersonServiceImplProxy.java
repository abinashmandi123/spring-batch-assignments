...
public class PersonServiceImplProxy implements com.abinash.jaxws.service.PersonServiceImpl {
  private String _endpoint = null;
  private com.abinash.jaxws.service.PersonServiceImpl personServiceImpl = null;
  ...
  private void _initPersonServiceImplProxy() {
    try {
      personServiceImpl = (new com.abinash.jaxws.service.PersonServiceImplServiceLocator()).getPersonServiceImpl();
  ...
  public com.abinash.jaxws.service.PersonServiceImpl getPersonServiceImpl() {
    if (personServiceImpl == null)
      _initPersonServiceImplProxy();
