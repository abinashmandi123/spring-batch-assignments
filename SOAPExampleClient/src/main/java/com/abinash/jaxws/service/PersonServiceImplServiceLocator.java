...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.abinash.jaxws.service.PersonServiceImplService {
    ...
    private java.lang.String PersonServiceImpl_address = "http://localhost:8082/SOAPExample/services/PersonServiceImpl";
    ...
    public com.abinash.jaxws.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.abinash.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.abinash.jaxws.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.abinash.jaxws.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.abinash.jaxws.service.PersonServiceImplSoapBindingStub _stub = new com.abinash.jaxws.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.jaxws.abinash.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.jaxws.abinash.com", "PersonServiceImpl"));
        }
