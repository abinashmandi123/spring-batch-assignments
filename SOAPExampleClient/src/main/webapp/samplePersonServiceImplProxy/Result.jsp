...
<jsp:useBean id="samplePersonServiceImplProxyid" scope="session" class="com.abinash.jaxws.service.PersonServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.abinash.jaxws.service.PersonServiceImpl getPersonServiceImpl10mtemp = samplePersonServiceImplProxyid.getPersonServiceImpl();
...
case 15:
        ...
        %>
        <jsp:useBean id="com1abinash1jaxws1beans1Person_1id" scope="session" class="com.abinash.jaxws.beans.Person" />
        <%
        com1abinash1jaxws1beans1Person_1id.setAge(age_2idTemp);
        com1abinash1jaxws1beans1Person_1id.setName(name_3idTemp);
        com1abinash1jaxws1beans1Person_1id.setId(id_4idTemp);
        boolean addPerson15mtemp = samplePersonServiceImplProxyid.addPerson(com1abinash1jaxws1beans1Person_1id);
...
case 31:
        ...
        com.abinash.jaxws.beans.Person getPerson31mtemp = samplePersonServiceImplProxyid.getPerson(id_6idTemp);
...
case 42:
        gotMethod = true;
        com.abinash.jaxws.beans.Person[] getAllPersons42mtemp = samplePersonServiceImplProxyid.getAllPersons();
...
<%
        ...
        if(getAllPersons42mtemp != null){
        java.util.List<com.abinash.jaxws.beans.Person> listreturnp43= java.util.Arrays.asList(getAllPersons42mtemp);
        //tempreturnp43 = listreturnp43.toString();
        for(com.abinash.jaxws.beans.Person p : listreturnp43){
        	int id = p.getId();
        	int age = p.getAge();
